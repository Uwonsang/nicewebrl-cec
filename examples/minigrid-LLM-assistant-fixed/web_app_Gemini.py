...
async def global_handle_key_press(e, container):
    ...
    try:
        active_id = await e.client.run_javascript('document.activeElement ? document.activeElement.id : ""')
...
async def start_experiment(container):
    ...
    try:
        ...
        with container:
            ...
            container.on('keydown', lambda e, c=container: asyncio.create_task(global_handle_key_press(e, c)))
            ui.timer(
                0.01,
